            ...
            <div className="schema-view">
              ...
              <div className="schema-row">
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
                  <div style={{ fontSize: '0.65rem', color: '#4b9eff' }}>Зона движения</div>
              ...
              <div style={{ fontSize: '0.68rem', color: '#485f7a', marginTop: 8 }}>→ После верификации — выезд на Зону Д</div>
            </div>
        ...
        <div className="detail-section">
          ...
          <div className="detail-section-body">
            ...
            <div className="floor-diagram" style={{ marginTop: 0 }}>
              ...
              <div className="floor-rooms">
                <div className="floor-room" style={{ borderColor: '#93c5fd', color: '#93c5fd', background: '#251d0e' }}>
                  Охранник СБ-2<br/>
        ...
        <div className="detail-section">
          ...
          <div className="detail-section-body">
            ...
            <div style={{
              ...
              <div style={{ fontSize: '0.65rem', color: '#4b9eff', opacity: 0.6, marginBottom: 8, letterSpacing: '0.15em' }}>
              ...
              <div style={{ fontSize: '0.7rem', color: '#4b9eff', marginTop: 10, opacity: 0.6 }}>
